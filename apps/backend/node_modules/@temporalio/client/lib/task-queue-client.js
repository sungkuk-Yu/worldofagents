...
exports.BuildIdNotFoundError = exports.reachabilityResponseFromProto = exports.TaskQueueClient = exports.UnversionedBuildId = void 0;
...
function reachabilityTypeToProto(type) {
    switch (type) {
        case null:
        case undefined:
        ...
        default:
            (0, type_helpers_1.assertNever)('Unknown Build Id reachability operation', type);
    }
}
...
function reachabilityTypeFromProto(rtype) {
    switch (rtype) {
        ...
        default:
            return (0, type_helpers_1.assertNever)('Unknown Build Id reachability operation', rtype);
    }
}
/**
