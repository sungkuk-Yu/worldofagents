...
class Worker {
    ...
    activityOperator() {
        return (0, rxjs_1.pipe)((0, rxutils_1.closeableGroupBy)(({ base64TaskToken }) => base64TaskToken), (0, operators_1.mergeMap)((group$) => {
            return group$.pipe((0, rxutils_1.mergeMapWithState)(async (activity, { task, base64TaskToken }) => {
                ...
                switch (variant) {
                    case 'start': {
                        ...
                        this.log.trace('Starting activity', (0, activity_1.activityLogAttributes)(info));
                    ...
                    case 'cancel': {
                        ...
                        this.log.trace('Cancelling activity', (0, activity_1.activityLogAttributes)(activity.info));
    ...
    async handleActivation(workflow, { activation, synthetic }) {
        try {
            ...
            if (workflow === undefined) {
                ...
                const maybeStartWorkflow = activation.jobs.find((j) => j.startWorkflow != null);
    ...
    async createWorkflow(activation, startWorkflow) {
        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
        const workflowCreator = this.workflowCreator;
        if (!(startWorkflow.workflowId != null &&
    ...
    activityHeartbeat$() {
        ...
        this.takeUntilState('DRAINED'), (0, operators_1.tap)({
            ...
            switch (input.type) {
                case 'heartbeat':
                    this.log.trace('Got activity heartbeat', (0, activity_1.activityLogAttributes)(input.info));
                    if (state.processing) {
