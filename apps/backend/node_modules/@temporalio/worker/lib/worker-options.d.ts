 ...
 */
export interface CompiledWorkerOptions extends Omit<WorkerOptionsWithDefaults, 'serverOptions' | 'interceptors' | 'activities'> {
 ...
 */
export interface ReplayWorkerOptions extends Omit<WorkerOptions, 'connection' | 'namespace' | 'taskQueue' | 'activities' | 'maxConcurrentActivityTaskExecutions' | 'maxConcurrentLocalActivityExecutions' | 'maxConcurrentWorkflowTaskExecutions' | 'maxConcurrentActivityTaskPolls' | 'maxConcurrentWorkflowTaskPolls' | 'nonStickyToStickyPollRatio' | 'maxHeartbeatThrottleInterval' | 'defaultHeartbeatThrottleInterval' | 'debugMode' | 'enableNonLocalActivities' | 'maxActivitiesPerSecond' | 'maxTaskQueueActivitiesPerSecond' | 'stickyQueueScheduleToStartTimeout' | 'maxCachedWorkflows' | 'useVersioning'> {
    /**
...
export declare function compileWorkerInterceptors({ activity, activityInbound, // eslint-disable-line deprecation/deprecation
workflowModules, }: Required<WorkerInterceptors>): CompiledWorkerInterceptors;
