...
export function CardActions({ message, handlers }: CardProps) {
  ...
  return <View style={s.actions}>
    <Text style={s.micro} testID="ai-generated-badge">{t('common.aiGenerated')}</Text>
...
export default function CardFrame(props: CardProps & { agentName: string; compact?: boolean }) {
