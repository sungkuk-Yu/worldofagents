...
const files = ['App.tsx', ...['ChatScreen', 'LoginScreen', 'DialogueListScreen', 'SettingsScreen'].map((name) => `src/screens/${name}.tsx`), 'src/lib/chatLogic.ts', 'src/lib/api.ts', 'src/hooks/useChatSession.ts'];
let violations = 0;
